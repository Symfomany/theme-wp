...
function twentyseventeen_deps() {
	...
	wp_enqueue_style( 'twentyseventeen-magnific', get_theme_file_uri( '/assets/css/magnific-popup.css' ) );
	wp_enqueue_style( 'twentyseventeen-animate', get_theme_file_uri( '/assets/css/animate.css' ) );
	wp_enqueue_style( 'twentyseventeen-normalize', get_theme_file_uri( '/assets/css/normalize.css' ) );
	wp_enqueue_style( 'twentyseventeen-style', get_theme_file_uri( '/assets/css/style.css' ) );
	...
	wp_enqueue_script( 'scroll', get_theme_file_uri( '/assets/js/smooth-scroll.js' ), null, true, true );
	wp_enqueue_script( 'magnific', get_theme_file_uri( '/assets/js/jquery.magnific-popup.min.js' ) , null , true, true);
	wp_enqueue_script( 'counterup', get_theme_file_uri( '/assets/js/jquery.counterup.min.js' ), null , true, true);
	wp_enqueue_script( 'waypoint', get_theme_file_uri( '/assets/js/waypoints.min.js' ), null ,true, true );
	wp_enqueue_script( 'syotimer', get_theme_file_uri( '/assets/js/jquery.syotimer.min.js' ), true, true );
	wp_enqueue_script( 'wow', get_theme_file_uri( '/assets/js/wow.min.js' ) ,  null ,true, true);
